...
public class UndoAction {
    ...
    private static boolean moveLostOwnership(BoardStatus board,
            Move topMove) {
    ...
    private static void restoreSectionToPlayIn(BoardStatus board,
            Stack<Move> allMoves, BoxPosition topMove) {
        ...
        if (allMoves.size() > 0) {
            ...
            sectionToRestoreTo = TicTacToeEngine
                    .getSectionToPlayInNext(previousMove);
        } else {
